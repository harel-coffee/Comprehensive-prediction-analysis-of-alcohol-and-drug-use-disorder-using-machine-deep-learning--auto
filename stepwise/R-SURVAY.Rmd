...
#data1$AGE <- cut(data1$AGE, c(15, 21, 35, 45, 65,100), c(0, 1, 2, 3,4), include.lowest=TRUE)
#data1$DRUGDAYS <- cut(data1$DRUGDAYS, c(0, 1, 10, 20, 31), c(0, 1, 2,3), include.lowest=TRUE)
#data1$ALCDRUGS <- cut(data1$ALCDRUGS, c(0, 1, 10, 20, 31), c(0, 1, 2,3), include.lowest=TRUE)
#drop <- c("HALLUC","BIRTH","METHADONE","OTHERDRUGS","ID","SCREEN","BINGEDAYS")
